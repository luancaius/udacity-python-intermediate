...
class NearEarthObject:
    ...
    def fullname(self):
        ...
        result = f'{self.designation}-{self.name}' if self.name else f'{self.designation}'
        return result
    ...
    def __str__(self):
        ...
        return f"A NearEarthObject named {self.name} ({self.designation}) with diameter {self.diameter} km of diameter"
